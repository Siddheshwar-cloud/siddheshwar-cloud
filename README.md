...
const sidheshwar = {
    ...
    currentFocus: [
        ...
        "Contributing to Web3 communities"
    ],
    
    goals2025: "Launch my own dApp & contribute to major DeFi protocols"
};
```

<br/>

- 🔭 **Currently working on:** Blockchain-based projects & smart contracts
...
**Open to collaborating on blockchain projects, Web3 innovations, and decentralized tech discussions!**
...
💬 **Ask me about:** Blockchain • Solidity • Smart Contracts • Web3 • dApps • DeFi
